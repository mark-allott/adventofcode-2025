...
namespace AdventOfCode.Challenges.Day08
{
		...
		: BaseDailyChallenge, IAutoRegister
	{
		...
		private const int PartOneExpected = 40;

		private const int PartTwoExpected = 25272;
	}
}